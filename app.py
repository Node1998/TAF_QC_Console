...
def insert_log(data, qc, source):
    ...
    """, (
        ...
        data.get("wind_gust"), data.get("visibility"),
        data.get("cloud_layers"),
        data.get("weather_phenomena"), data.get("altimeter"),
        data.get("change_groups"), qc["status"], qc["score"], source,
        data.get("raw_text"),
...
--mono:"JetBrains Mono","SFMono-Regular","Cascadia Code",Consolas,
...
def api_process():
    ...
    if mode == "live":
        ...
        source = "MANUAL"
    qc = qc_process(data)
    rowid = insert_log(data, qc, source)
